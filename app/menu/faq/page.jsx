...
const FaqPageContent = () => {
  ...
  if (status === 'loading') return <div className="notice-loading">{string.loading}</div>;
  if (status === 'error') return <div className="notice-error">{string.error}</div>;
  ...
  return (
    <div id="notice">
      <div className="notice-container">
        ...
        {isFetchingNextPage && (
          <div className="notice-loading-more">{string.loadingMore}</div>
        )}
      </div>
    </div>
  );
